...
function menuBienvenue () {
    ...
    document.querySelector(".buttun").onmouseenter = function hover_jouer(){
        buttun_jouer.style.backgroundColor = "red"
    }

    document.querySelector(".buttun").onmouseleave = function hover_jouer(){
        buttun_jouer.style.backgroundColor = ""
    }
