...
function subMenuEdition(){
    ...
    const text_quit = document.createElement("span");
    const btn_quit = document.createElement("button");
    ...
    btn_quit.style.display = "flex";
    btn_quit.id="export";
    btn_quit.style.backgroundColor = "#FFBB0B";
    btn_quit.style.justifyContent = "center";
    btn_quit.style.alignItems = "center";
    btn_quit.style.height = "12%";
    btn_quit.style.width = "35%";
    btn_quit.style.border ="solid 3px #FFFFFF";
    btn_quit.style.borderRadius = "25px";
    btn_quit.style.margin = "17% 35%";
    btn_quit.style.cursor = "pointer";
    ...
    quit_edition.appendChild(text_quit);
